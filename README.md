...
Pair Partner - [Adrian Eyre] (https://github.com/adrianeyre)
...
```shell
> git remote add <pair-partner> <URL-to-pair-partners-repo>     # Link my repository with Adrian's

> git fetch                                                     # Fetch Adrian's repository
